                ...
                <div class="panel-body">
                    <form role="form" action="admin/update.html" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input value="${requestScope.admin.login}" name="login" type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">用户昵称</label>
                            <input value="${requestScope.admin.userName}" name="userName" type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
